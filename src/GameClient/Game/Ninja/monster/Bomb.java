...
public class Bomb extends FruitGoc{
    
    

    BufferedImage bomb = getPlayerImage("./sprites/Bomb.png");
    ...
    public Bomb(NinjaPanel gp, Map map ) {
    ...
    public void newApple(){
        ...
        x=(4+rand.nextInt(31))*gp.tileSize/2; 
        y=(4+rand.nextInt(31))*gp.tileSize/2;
    ...
    public void draw(Graphics2D g2) {
        g2.drawImage(bomb,map.Mapx+x,map.Mapy+y,gp.tileSize, gp.tileSize,null);
